...
import ARView from "@/components/layout/ARViewRutaDefensaEnd";
  ...
  return (
    <div style={{ width: "100%", height: "100vh", position: "relative" }}>
      ...
      <ARView
        ...
        audioUrl={`/audios/${locale === 'ca' ? 'rutaendcatalan' : locale === 'es' ? 'rutaendspanish' : locale === 'fr' ? 'rutaendfrench' : 'rutaendenglish'}.mp3`}
        linkLoad={true}
        from="POI"
      />
    </div>
