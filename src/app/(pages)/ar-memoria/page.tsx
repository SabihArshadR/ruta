...
import ARView from "@/components/layout/ARViewMemoria";
  ...
  return (
    <div style={{ width: "100%", height: "100vh", position: "relative" }}>
      ...
      <ARView
        ...
        audioUrl={`/audios/${locale === 'ca' ? 'memoriacatalan' : locale === 'es' ? 'memoriaspanish' : locale === 'fr' ? 'memoriafrench' : 'memoriaenglish'}.mp3`}
        linkLoad={true}
        from="POI"
      />
    </div>
