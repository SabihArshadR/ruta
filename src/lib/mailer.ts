...
export async function sendVerificationEmail(to: string, code: string, name: string, language: string = 'ca') {
  const emailTemplates = {
    en: {
      subject: "Verification Code – Els camins de la memòria",
      text: `
Hello ${name},

Thank you for registering at Els camins de la memòria.
...
This is an automatic email, no reply is needed.
      ...
      html: `
        <p>Hello <b>${name}</b>,</p>
        <p>Thank you for registering at <b>Els camins de la memòria</b>.</p>
    ...
    ca: {
      subject: "Codi de verificació – Els camins de la memòria",
      text: `
Hola ${name},

Gràcies per registrar-te a Els camins de la memòria.
...
Aquest és un correu automàtic, no cal respondre.
      ...
      html: `
        <p>Hola <b>${name}</b>,</p>
        <p>Gràcies per registrar-te a <b>Els camins de la memòria</b>.</p>
    ...
    es: {
      subject: "Código de verificación – Los caminos de la memoria",
      text: `
Hola ${name},

Gracias por registrarte en Los caminos de la memoria.
...
Este es un correo automático, no es necesario responder.
      ...
      html: `
        <p>Hola <b>${name}</b>,</p>
        <p>Gracias por registrarte en <b>Los caminos de la memoria</b>.</p>
    ...
    fr: {
      subject: "Code de vérification – Les chemins de la mémoire",
      text: `
Bonjour ${name},

Merci de vous être inscrit à Les chemins de la mémoire.
...
Ceci est un courriel automatique, aucune réponse n'est nécessaire.
      ...
      html: `
        ...
        <p>Merci de vous être inscrit à <b>Les chemins de la mémoire</b>.</p>
  ...
  const mailOptions = {
    from: `Els camins de la memòria <${process.env.SMTP_USER}>`,
    to,
...
export async function sendConfirmationEmail(to: string, name: string, language: string = 'ca') {
  const emailTemplates = {
    en: {
      subject: "Registration Confirmation – Els camins de la memòria",
      text: `
Hello ${name},

Your registration at Els camins de la memòria has been successfully completed.
...
This is an automatic email, no reply is needed.
      ...
      html: `
        <p>Hello <b>${name}</b>,</p>
        <p>Your registration at <b>Els camins de la memòria</b> has been successfully completed.</p>
    ...
    ca: {
      subject: "Confirmació de registre – Els camins de la memòria",
      text: `
Hola ${name},

El teu registre a Els camins de la memòria s'ha completat correctament.
...
Aquest és un correu automàtic, no cal respondre'l.
      ...
      html: `
        <p>Hola <b>${name}</b>,</p>
        <p>El teu registre a <b>Els camins de la memòria</b> s'ha completat correctament.</p>
    ...
    es: {
      subject: "Confirmación de registro – Los caminos de la memoria",
      text: `
Hola ${name},

Tu registro en Los caminos de la memoria se ha completado correctamente.
...
Este es un correo automático, no es necesario responder.
      ...
      html: `
        <p>Hola <b>${name}</b>,</p>
        <p>Tu registro en <b>Los caminos de la memoria</b> se ha completado correctamente.</p>
    ...
    fr: {
      subject: "Confirmation d'inscription – Les chemins de la mémoire",
      text: `
Bonjour ${name},

Votre inscription à Les chemins de la mémoire a été effectuée avec succès.
...
Ceci est un courriel automatique, aucune réponse n'est nécessaire.
      ...
      html: `
        <p>Bonjour <b>${name}</b>,</p>
        <p>Votre inscription à <b>Les chemins de la mémoire</b> a été effectuée avec succès.</p>
...
export async function sendResetPasswordEmail(to: string, name: string, resetUrl: string) {
  const mailOptions = {
    from: `Els camins de la memòria <${process.env.SMTP_USER}>`,
    to,
    subject: "Recuperació de contrasenya – Els camins de la memòria",
    text: `
Hola ${name},

Hem rebut una sol·licitud per restablir la contrasenya del teu compte a Els camins de la memòria.
...
Aquest és un correu automàtic, no cal respondre.
    ...
    html: `
      <p>Hola <b>${name}</b>,</p>
      <p>Hem rebut una sol·licitud per restablir la contrasenya del teu compte a <b>Els camins de la memòria</b>.</p>
