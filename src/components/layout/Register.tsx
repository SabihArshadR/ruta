...
const Register = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center px-4 min-h-screen bg-white pb-5">
      ...
      <div className="desktop:max-w-[400px] tablet:max-w-[400px] mobile:w-full">
        ...
        <div className="mt-[49px] flex flex-col gap-[22px] text-darkgreen">
          <div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <span
                ...
                className="absolute right-3 top-3.5 cursor-pointer text-backblack"
              >
        ...
        <div className="mt-[47px] flex flex-col gap-7">
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span className="text-backblack">{t("check1")}</span>
          </label>
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span className="text-backblack">
              {t("check21")}{" "}
              <span onClick={() => setShowPrivacyPolicy(true)} className="text-[#009FB6]">{t("check22")}</span>
            </span>
          </label>
        </div>
        ...
        <div className="flex flex-col gap-4 mt-[45px]">
          ...
          <div className="flex items-center">
            ...
            <span className="poppins-medium font-medium text-backblack text-[17px] leading-none !mx-4">
              OR
            </span>
