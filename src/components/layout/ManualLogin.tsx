    ...
    <div className="flex flex-col items-center py-5 px-4 h-[80vh] bg-white">
      <div className="desktop:max-w-[400px] tablet:max-w-[400px] mobile:w-full mt-10">
        <div className="flex flex-col gap-[22px]">
          <div>
            <h1 className="mb-2 text-darkgreen">{t1("field3")}*</h1>
            <CustomInput
              value={email}
          ...
          <div>
            <h1 className="mb-2 text-darkgreen">{t1("field4")}*</h1>
            <div className="relative">
              ...
              <span
                ...
                className="absolute right-3 top-3.5 cursor-pointer text-darkgreen"
              >
        ...
        <div className="flex flex-col gap-4 mt-[45px]">
          ...
          <CustomButton
            onClick={() => {
              playButtonSound();
              signIn("google", { callbackUrl: "/rutadefensacostest" });
            }}
          ...
          <CustomButton
            onClick={() => {
              playButtonSound();
              signIn("azure-ad", { callbackUrl: "/rutadefensacostest" },)}
            }
