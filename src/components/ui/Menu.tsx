  ...
  return (
    <>
      ...
      >
        ...
        <NavbarMenu
          className={`absolute top-0 desktop:w-[400px] max-h-[600px] tablet:w-[400px] bg-backblack desktop:mx-auto mobile:w-full flex flex-col`}
        >
          <div className="flex gap-5 justify-between my-auto !mt-3 px-2 pb-5">
            <div className="flex flex-col my-auto !mt-24 gap-2">
              <Link
                href="/mapa"
                className="text-white text-[20px] p-2 font-bold hover:bg-darkgreen block"
              >
                {t2("card1")}
              </Link>
              <Link
